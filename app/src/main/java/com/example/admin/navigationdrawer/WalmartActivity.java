...
public class WalmartActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    WebView wv;
    NavigationView nv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv = findViewById(R.id.webViewWalmart);
        nv = findViewById(R.id.navigationView);
        nv.setNavigationItemSelectedListener(this);
        WebSettings webSettings = wv.getSettings();
        webSettings.setJavaScriptEnabled(true);
        wv.setWebViewClient(new WebViewClient());
        wv.loadUrl("https://www.walmart.com/");
        Toolbar myToolbar = (Toolbar) findViewById(R.id.my_toolbar_walmart);
        dl = findViewById(R.id.drawerLayoutWalmart);
