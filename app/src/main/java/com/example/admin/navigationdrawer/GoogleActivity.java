...
public class GoogleActivity extends AppCompatActivity implements OnNavigationItemSelectedListener{
    WebView wv;
    NavigationView nv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv = findViewById(R.id.webViewGoogle);
        ...
        Toolbar myToolbar = (Toolbar) findViewById(R.id.my_toolbar_google);
        dl = findViewById(R.id.drawerLayoutGoogle);
