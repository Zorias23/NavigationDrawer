...
public class ThinkActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    WebView wv;
    NavigationView nv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv = findViewById(R.id.webViewThink);
        nv = findViewById(R.id.navigationView);
        nv.setNavigationItemSelectedListener(this);
        WebSettings webSettings = wv.getSettings();
        webSettings.setJavaScriptEnabled(true);
        wv.setWebViewClient(new WebViewClient());
        wv.loadUrl("http://www.thinkgeek.com/");
        Toolbar myToolbar = (Toolbar) findViewById(R.id.my_toolbar_think);
        dl = findViewById(R.id.drawerLayoutThink);
