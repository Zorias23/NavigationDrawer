...
public class DepotActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    WebView wv;
    NavigationView nv;
    private String TAG = "DepotActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv = findViewById(R.id.webViewDepot);
        nv = findViewById(R.id.navigationView);
        nv.setNavigationItemSelectedListener(this);
        WebSettings webSettings = wv.getSettings();
        webSettings.setJavaScriptEnabled(true);
        wv.setWebViewClient(new WebViewClient());
        wv.loadUrl("https://www.homedepot.com/");
        nv.setNavigationItemSelectedListener(this);
        Toolbar myToolbar = (Toolbar) findViewById(R.id.my_toolbar_depot);
        dl = findViewById(R.id.drawerLayoutDepot);
