...
public class NbaActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    WebView wv;
    NavigationView nv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv.loadUrl("http://www.nba.com/news#/");
        Toolbar myToolbar = (Toolbar) findViewById(R.id.my_toolbar_nba);
        dl = findViewById(R.id.drawerLayoutNba);
